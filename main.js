...
const connectionOptions = {
  ...
  mobile: MethodMobile,
  browser: opcion === '1' ? ['Nerrito-Bot', 'Safari', '2.0.0'] : methodCodeQR ? ['Nerrito-Bot', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
  auth: {
    creds: state.creds,
...
async function connectionUpdate(update) {
  ...
  if (reason == 405) {
    await fs.unlinkSync("./NerritoSession/" + "creds.json")
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = '_*HASTA LA VISTA CHAVISTA INFELIZ*_';
...
setInterval(async () => {
  ...
  const bio = `• Activo: ${uptime} | Nerrito-Bot`;
